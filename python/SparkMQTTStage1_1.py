...
# technique and sends the result back to Calvin via MQTT. Makes use of Spark
# mqtt assembly package to connect to MQTT broker to collect data and Paho
# MQTT client package is used to publish data.
#
# iotx stage 1 demo
#
# Author: Aarti Gorade
